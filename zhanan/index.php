...
require '../config.php';
$db = new DBUtils();
$db -> instance('../db/zhanan.db3');
$word=$_GET['word']??NULL;
$list=$_GET['list']??NULL;
/*
$url='https://api.lovelive.tools/api/SweetNothings/10000/Serialization/json?genderType=F';
...
foreach($data as $r){
	...
	if (!$a){
		$db->execute('insert into content (content,type)values("'.$r.'",1)');
	}
}
*/
